...
static struct FeatureDesc {
  ...
  F_I(BUFFERPOOL, 0, 100000000, 0),
  F_B(HAS_FERGUSON_FLUSHER, 0, 0, 0),
  F_I(CLIENT_FLOOD, 0, 4048, 0),
  F_I(SERVER_PORT, FEAT_OPER, 4444, 0),
  F_B(NODEFAULTMOTD, 0, 0, 0),
  ...
  F_S(HIDDEN_HOST, FEAT_CASE, "users.astrolink.org", 0),
  ...
  F_S(HIS_SERVERNAME, 0, "*.astrolink.org", feature_notify_servername),
  F_S(HIS_SERVERINFO, 0, "The Astrolink IRC Network", feature_notify_serverinfo),
  F_S(HIS_URLSERVERS, 0, "http://www.astrolink.org/servers/", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "Astrolink", 0),
  F_S(URL_CLIENTS, 0, "ftp://ftp.undernet.org/pub/irc/clients", 0),
  F_S(URLREG, 0, "http://www.astrolink.org/knowledge-base/how-do-i-register-my-nickname/", 0),
